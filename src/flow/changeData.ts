...
export async  function changeCandidato(params:any){
    const url = 'https://hirbo.arvispace.com/Back/services/RutasPublic.php?interviewChatbot';
    try {
...
export async  function existUser(number:any,id:any){
    const url = 'https://hirbo.arvispace.com/Back/services/RutasPublic.php?infoCandidato';
    try {
...
export async  function validCode(org:any,num:any,code:any){
    const url = 'https://hirbo.arvispace.com/Back/services/RutasPublic.php?getInfoValidCode';
    try {
...
export async  function getCampaniasChange(key:any){
    const url = 'https://hirbo.arvispace.com/Back/services/RutasPublic.php?getCampanias';
    try {
...
export async  function changeStatusVacante(org:any,cam:any,req:any,cand:any,){
    const url = 'https://hirbo.arvispace.com/Back/services/RutasPublic.php?getInfoVacante';
    try {
...
export async  function getRequisicionesChange(org:any,campain:any){
    const url = 'https://hirbo.arvispace.com/Back/services/RutasPublic.php?getRequisiciones';
    try {
...
export async  function updateStatus(id:any,tbl:any){
    const url = 'https://hirbo.arvispace.com/Back/services/RutasPublic.php?updateStatus';
    try {
...
export async  function getAnswersChange(org:any,campain:any,idreq:any){
    const url = 'https://hirbo.arvispace.com/Back/services/RutasPublic.php?getQuestions';
    try {
